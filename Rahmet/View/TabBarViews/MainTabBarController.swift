...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        viewControllers = [
            ...
            NavigationVCGenerator.generateNavigationController(rootViewController: MyOrdersViewController(), image: ImageResizer.resizeImage(image: #imageLiteral(resourceName: "Image"), width: 22, height: 22), title: "Мои заказы", prefersLargeTitle: true),
